...
def start_pannel():  
    buttons  = [
            ...
            [ 
                InlineKeyboardButton(text="📨Official Channel", url="https://t.me/SobatAnime"),
                InlineKeyboardButton(text="📨Support Group", url="https://t.me/infomabarml")
            ],
    ]
...
pstart_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "📢 Uᴘᴅᴀᴛᴇꜱ 📢", url=f"https://t.me/sobatanime"), 
                    InlineKeyboardButton(
                        "💬 Sᴜᴘᴘᴏʀᴛ 💬", url=f"https://t.me/infomabarml")
                ],
                [ InlineKeyboardButton("🧑‍💻 Sᴏᴜʀᴄᴇ Cᴏᴅᴇ 🧑‍💻", url=f"https://Xnxx.com"),]
